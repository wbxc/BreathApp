...
import com.hhd.breath.app.wchusbdriver.CH340HealthDriver;
...
public class BreathHealthActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breath_health);
        ButterKnife.bind(this);
        healthDatas = new ArrayList<HealthData>() ;
        healthDatas = HealthDataService.getInstance(BreathHealthActivity.this).findHealths(ShareUtils.getUserId(BreathHealthActivity.this)) ;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.back_re:
                BreathHealthActivity.this.finish();
                break;
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (GlobalUsbService.isOpenBreath){
                            ...
                            intent.setClass(BreathHealthActivity.this, HealthCheck.class) ;
                            startActivityForResult(intent,10);
                        }else {
                            try {
                                if (Global340Driver.getInstance(BreathHealthActivity.this).send("2")){
                                    GlobalUsbService.isOpenBreath = true ;
                                    Intent intent = new Intent() ;
                                    intent.setClass(BreathHealthActivity.this, HealthCheck.class) ;
                                    startActivityForResult(intent, 10);
                                }else {
                                    BreathApplication.toastTest(BreathHealthActivity.this,getString(R.string.string_health_error_init));
                                }
                            }catch (Exception e){
                                ...
                                BreathApplication.toast(BreathHealthActivity.this, getString(R.string.string_health_no_connect));
                            }
            ...
            case 12:
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        getValue(1);
                        changeBtn(1);
                        BreathApplication.toast(BreathHealthActivity.this, "数据保存成功");
                    }
                }) ;
                break;
            case 11:
                BreathApplication.toast(BreathHealthActivity.this,"数据保存失败");
                break;
            case 13:
                BreathApplication.toast(BreathHealthActivity.this,"测试数据");
                break;
        }
    }
}
