 ...
 *
 */
public class RoundNoProgressBar extends View {
	/**
	 * 画笔对象的引用
	 */
	private Paint paint;
...
/*	RotateAnimation ra = new RotateAnimation(start, -degree,
	...
	*/
	...
	public RoundNoProgressBar(Context context) {
		this(context, null);
	}

	public RoundNoProgressBar(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public RoundNoProgressBar(Context context, AttributeSet attrs, int defStyle) {
...
/*		Shader mShader = new RadialGradient((float) (centre + rd * Math.cos((startAngle+360 * progress / max) * 3.14 / 180)),
	...
	private Animation pointRotationAnima(float fromDegrees, float toDegrees) {
		...
		RotateAnimation animation = new RotateAnimation(fromDegrees,
				toDegrees, Animation.RELATIVE_TO_PARENT, (float)(centre + rd * Math.cos((startAngle+360 * progress / max) * 3.14 / 180)),
				Animation.RELATIVE_TO_PARENT, (float) (centre + rd * Math.sin((startAngle+360 * progress / max) * 3.14 / 180)));
	...
	public synchronized void setProgress(int progress,View view ) {
		...
		layoutParams.height = (int) (centre + rd * Math.sin((startAngle+360 * progress / max) * 3.14 / 180)) ;
		layoutParams.width = (int)(centre + rd * Math.cos((startAngle+360 * progress / max) * 3.14 / 180)) ;
