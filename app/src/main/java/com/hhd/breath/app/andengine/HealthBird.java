...
public class HealthBird {
    ...
    public static final float BIRD_WIDTH = 83f ;
    public static final float BIRD_HEIGHT = 60 ;
    ...
    public HealthBird(float birdXOffset , float birdYOffset , VertexBufferObjectManager mVertexBufferObjectManager, Scene mScene){
        ...
        mSprite = new AnimatedSprite(birdXOffset,birdYOffset,BIRD_WIDTH,BIRD_HEIGHT,mBirdTiledTextureRegion,mVertexBufferObjectManager) ;
        mSprite.animate(25);
        mSprite.setZIndex(2);
