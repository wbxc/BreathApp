...
public class BreathDetailReport {
    ...
    public ContentValues toContentValues(BreathDetailReport data){
        ...
        contentValues.put(DBManger.TRAIN_HIS_IS_DELETE,data.getIs_delete());
