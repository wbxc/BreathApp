...
//        this.setOrientation(VERTICAL);
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#009EA0"));
            } else {
                itemView.setTextColor(Color.parseColor("#343434"));
            }
        }
    }
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
            onWheelViewListener.onSelected(selectedIndex-offset, items.get(selectedIndex-offset));
        }
    ...
    public String getSeletedItem() {
        return items.get(selectedIndex-offset);
    }
