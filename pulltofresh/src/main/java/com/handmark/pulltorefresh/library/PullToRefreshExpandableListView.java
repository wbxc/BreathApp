...
public class PullToRefreshExpandableListView extends PullToRefreshAdapterViewBase<MyExpandableListView> {
	...
	@Override
	protected MyExpandableListView createRefreshableView(Context context, AttributeSet attrs) {
		final MyExpandableListView lv;
	...
	class InternalExpandableListView extends MyExpandableListView implements EmptyViewMethodAccessor {
